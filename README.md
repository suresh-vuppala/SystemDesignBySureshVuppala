...
| 75 | Timeouts, Retries, Circuit Breakers, Fallback | Exponential backoff, jitter, Hystrix/Resilience4j patterns | [Martin Fowler — Circuit Breaker](https://martinfowler.com/bliki/CircuitBreaker.html) · [Hussein Nasser](https://www.youtube.com/watch?v=ADHcBxEXvFA) | [Netflix — Hystrix](https://netflixtechblog.com/) · [Shopify — Resiliency](https://shopify.engineering/latest) |
